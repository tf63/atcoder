...
int main() {
    ...
    vecll all;
    vector<vecll> any;
    vector<map<int, int>> iany;
    any.push_back(vecll(0));
    iany.push_back(map<int, int>());
    int iiany = 0;
    ...
    rep(i, Q) {
        ...
        if (q == 1) {
            ...
            cin >> iq >> xq;
            if (iany.back().find(iq) == iany.back().end()) {
                iany.back()[iq] = iiany;
                any.back().push_back(0);
                iiany++;
            }
            any.back().at(iany.back()[iq]) += xq;
        } else {
            cin >> iq;
            if (step == 0) {
                if (iany.back().find(iq) == iany.back().end()) {
                    ...
                    cout << A.at(iq) + any.back().at(iany.back()[iq]) << endl;
                }
            } else {
                if (iany.back().find(iq) == iany.back().end()) {
                    cout << all.back() << endl;
                } else {
                    cout << all.back() + any.back().at(iany.back()[iq]) << endl;
                }
            }
        }
    }
