...
int main() {
    ...
    int y = 1;
    for (int i = 2; i <= N; i++) {
        // if (A.at(i) == A.at(i - 1) && A.at(i) == B.at(i) && B.at(i) == B.at(i - 1)) {
        //     cout << 0 << endl;
        //     cout << i << "d" << endl;
        //     return 0;
        // }
        ...
        // if (A.at(i) != B.at(i - 1) && B.at(i) != A.at(i - 1) && A.at(i) != A.at(i - 1) && B.at(i) != B.at(i - 1)) {
        //     dp.at(i) = (dp.at(i - 1) * 2) % mod;
        //     cout << i << "ta" << endl;
        // } else if ((A.at(i) == A.at(i - 1) && B.at(i) == B.at(i - 1)) ||
        //            (A.at(i) == B.at(i - 1) && B.at(i) == A.at(i - 1))) {
